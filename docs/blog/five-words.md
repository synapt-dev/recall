...
*Synapt is open source. Install: `pip install synapt`. Connect: `claude mcp add synapt -- synapt serve`. Star: [github.com/laynepenney/synapt](https://github.com/laynepenney/synapt).*
