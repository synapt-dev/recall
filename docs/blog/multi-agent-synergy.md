...
Where competitors are strong, they are strong in ways that matter. Memobase leads on temporal reasoning with 85.05% on the LOCOMO temporal subset. Zep follows at 79.79%. Both outperform our numbers at the time of the analysis. Hindsight holds state-of-the-art on the overall LOCOMO and LongMemEval benchmarks through aggressive hierarchical summarization. Mem0's J-score of 66.88 on LOCOMO is respectable given its relatively simple architecture.
